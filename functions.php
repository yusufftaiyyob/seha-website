...
<?php
    ...
    function signup($employee_id,$name,$email,$password,$repassword,$system,$dept,$type,$conn){
        $hashedPassword = encryption($password);

        $query = mysqli_query($conn,"INSERT INTO users(employee_id, name, email, password, `system`, department, type) VALUES('$employee_id','$name','$email','$hashedPassword','$system','$dept','$type')");
        ...
        if($query){
            ...
            echo "Query Error : " . "INSERT INTO users(employee_id, name, email, password, system, department, type) VALUES('$employee_id','$name','$email','$hashedPassword','$system','$dept','$type')" . "<br>" . mysqli_error($conn);
            echo "<br>";
